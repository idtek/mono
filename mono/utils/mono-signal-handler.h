...
#ifdef HOST_WIN32
#define MONO_SIG_HANDLER_SIGNATURE(ftn) ftn (gboolean* handled, EXCEPTION_POINTERS *_info, void *context)
#define MONO_SIG_HANDLER_FUNC(access, ftn) MONO_SIGNAL_HANDLER_FUNC (access, ftn, (gboolean* handled, EXCEPTION_POINTERS *_info, void *context))
#define MONO_SIG_HANDLER_PARAMS handled, _info, context
